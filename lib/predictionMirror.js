...
/** Guarda en otro participante (mismo email, otro grupo) predicciones fusionadas desde origen. */
export async function pushPredictionsToParticipant(
  supabase,
  participantId,
  targetRaw,
  sourceRaw,
  ...
  const merged = mergePredictions(targetRaw, sourceRaw, mode)
