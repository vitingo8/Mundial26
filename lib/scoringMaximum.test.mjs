...
import { calcScoringMaximum, getScoringColumnLimits, getScoringDisputedLimits, formatPtsOfMax, formatDisputedProgress } from './scoringMaximum.js'
...
test('getScoringDisputedLimits — plazas FotMob confirmadas', () => {
  const d = getScoringDisputedLimits(
    { results: { group: {}, knockout: {} }, actuals: {} },
    {
      groupMatches: [],
      knockoutMatches: [],
      fotmobStandings: { ready: true, resolvedCount: 6, byGroup: {} },
    },
  )
