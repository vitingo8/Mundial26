// ─── WORLD CUP 2026 DATA ──────────────────────────────────────────────────────
// 48 teams, 12 groups (4 teams each), USA + Canada + Mexico
...
export const GROUPS_DATA = {
  ...
  I: ["Países Bajos", "Senegal", "Ecuador", "Catar"],
  J: ["Canadá", "Bélgica", "Marruecos", "Croacia"],
  K: ["Alemania", "Japón", "España", "Costa Rica"],
  L: ["Suiza", "Brasil", "Serbia", "Camerún"],
}
