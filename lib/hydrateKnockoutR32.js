...
import { getCompletedGroupLetters, buildBracketQualifiersFromFotmob } from './groupStageCompletion.js'
import {
...
export function hydrateKnockoutR32FromStandings(
  ...
  const bracketByGroup = buildBracketQualifiersFromFotmob(rawByGroup, completed)
