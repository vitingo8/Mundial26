...
export function getScoringColumnLimits() {
  ...
  return {
    ...
    gepPts: roundPts(gepInicioRaw * PHASE_WEIGHT.inicio + gepKoRaw * PHASE_WEIGHT.knockoutReal),
    resultadoPts: roundPts(resInicioRaw * PHASE_WEIGHT.inicio + resKoRaw * PHASE_WEIGHT.knockoutReal),
    advancePts: roundPts(advInicioRaw * PHASE_WEIGHT.inicio + advKoRaw * PHASE_WEIGHT.knockoutReal),
    qualificationPts: roundPts(maxQualificationRaw() * PHASE_WEIGHT.inicio),
